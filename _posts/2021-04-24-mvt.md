...
for some $c\in (x_1,x_2). If $f^\prime(c) \geq 0$, then $f(x_2) \geq f(x_1)$. Thus, if $f^\prime(x) \geq 0$ for all $x\in I$, we have $f(x_2) \geq f(x_1)$ for all $x_1,x_2\in I$ with $x_1< x_2$. Thus, $f$ is monotone increasing on $I$.
