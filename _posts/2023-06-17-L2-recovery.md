...
Thus, $U(f, \mathcal{P}_{3}) - L(f, \mathcal{P}_{3}) \leq 4\delta M < \epsilon/3$. Now take a union of $\mathcal{P}_1, \mathcal{P}_2$ and $\mathcal{P}_3$ and let $\mathcal{P} = \bigcup_{i=1}^3  \mathcal{P}_i$. Then $U(f, P)- L(f,P) < \epsilon$.
