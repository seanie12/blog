...
Suppose $$m\geq n$$. Then $$\lvert a_m - a_n\rvert\leq \lvert b_n - a_n\rvert < \epsilon \text{ for } n\geq N \text{ s.t. } \frac{b_1-a_1}{2^{N-1}} < \epsilon.$$ Similarly, $$\lvert b_m-b_n\rvert\leq |a_n-b_n| < \epsilon.$$ Thus, $$\{a_n\}, \{b_n\}$$ are Cauchy sequence. 
