...
Let $\Psi^{\mathfrak{B}}_{\mathfrak{C}}: \mathcal{L}(V,W) \rightarrow \mathfrak{M}_{m\times n}(F)$ be a function such that $$\Psi^{\mathfrak{B}}_{\mathfrak{C}}(L) := [L]^{\mathfrak{B}}_{\mathfrak{C}}$$ for all $L \in \mathcal{L}(V,W)$.
